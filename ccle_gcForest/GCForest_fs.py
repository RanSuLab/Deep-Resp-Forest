...
class gcForest(object):
    ...
    def cascade_forest(self, X, y=None):
        ...
        if y is not None:
            ...
            self.n_layer += 1
            select_features=self.rf_fs(X_train, y_train)
            ...
            prf_crf_pred_ref = self._cascade_layer(X_train[:,select_features], y_train)
            ...
            prf_crf_pred_ref = self._cascade_layer(X[:,select_features], layer=at_layer)
